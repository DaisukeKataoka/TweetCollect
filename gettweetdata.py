...
import json, datetime, sqlite3, csv, time

dbname = "twitter.sqlite3"

Keys = {
        'consumer_key':'8TF9qptoTjm3j3EhI1a9jKFAi',
        'consumer_secret':'IOxjwKiC4BHdvp1JMzAIKIgSo8uxtJcgDOqRFGQOjvIYneWuKQ',
        'access_token':'761272495-kZOM6vf9zCt6otPI4FNbnynSX11guOGKrY7lOZvo',
        'access_secret':'qZ8FfvcKRbq9BiYkpSAcsl5Bun0Gx7uX6OZpLbia6s7G8'
        }

Follower_Count = 500
Tweet_Get_Count = 100 #<-件のtweetを取得 Max100
Follower_Get_Count = 20 #半端なくフォロワー多い人でも取得するが、API処理の関係で1200件まで
...
def get_dbdata(target_column, table_name, key, value):
